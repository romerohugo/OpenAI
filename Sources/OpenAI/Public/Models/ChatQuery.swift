...
public struct ProductsJsonSchema: Codable, Equatable {
    let type : String
    let json_schema: ProductsStructuredOutput
    
    public init(type: String, json_schema: ProductsStructuredOutput) {
        self.type = type
...
public struct ProductProperties: Codable, Equatable {
    ...
    let description: PropertyType
    let price: PropertyType
    let brand: PropertyType
    let categories: CategoriesSchema
    
    public init(name: PropertyType,description: PropertyType , price: PropertyType,brand:PropertyType, categories: CategoriesSchema) {
        self.name = name
        self.description = description
        self.price = price
        self.brand = brand
...
public struct ChatQuery: Equatable, Codable, Streamable {
    ...
    public let responseFormat: ProductsJsonSchema?
    ...
    public init(
        ...
        responseFormat: ProductsJsonSchema? = nil,
        seed: Int? = nil,
        stop: Self.Stop? = nil,
